CREATE TABLE `api_hits` (
  ...
  CONSTRAINT `api_hits_ibfk_1` FOREIGN KEY (`website_id`) REFERENCES `websites` (`id`),
  CONSTRAINT `api_hits_ibfk_2` FOREIGN KEY (`method_id`) REFERENCES `api_methods` (`id`)
...
CREATE TABLE `api_hits_keys` (
  ...
  CONSTRAINT `api_hits_keys_ibfk_1` FOREIGN KEY (`website_id`) REFERENCES `websites` (`id`),
  CONSTRAINT `api_hits_keys_ibfk_2` FOREIGN KEY (`method_id`) REFERENCES `api_methods` (`id`),
  CONSTRAINT `api_hits_keys_ibfk_3` FOREIGN KEY (`api_key_id`) REFERENCES `api_keys` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC;
...
CREATE TABLE `private_clicks` (
  ...
  CONSTRAINT `private_clicks_ibfk_1` FOREIGN KEY (`url_id`) REFERENCES `private_urls` (`id`) ON DELETE CASCADE,
...
CREATE TABLE `private_domains` (
  ...
  `domain` varchar(48) NOT NULL,
  `sequence` int(10) unsigned NOT NULL DEFAULT '500000',
...
CREATE TABLE `private_shortenings` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  ...
  KEY `url_id` (`url_id`),
  CONSTRAINT `private_shortenings_ibfk_1` FOREIGN KEY (`domain_id`) REFERENCES `private_domains` (`id`) ON DELETE CASCADE,
  CONSTRAINT `private_shortenings_ibfk_2` FOREIGN KEY (`url_id`) REFERENCES `url_destinations` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC;
...
CREATE TABLE `private_urls` (
  ...
  CONSTRAINT `private_urls_ibfk_1` FOREIGN KEY (`shortened_id`) REFERENCES `private_shortenings` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC;
...
CREATE TABLE `trim_click_regions` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  ...
  KEY `region_id` (`region_id`),
  KEY `city_id` (`city_id`),
  CONSTRAINT `trim_click_regions_ibfk_1` FOREIGN KEY (`click_id`) REFERENCES `trim_clicks` (`id`) ON DELETE CASCADE,
  CONSTRAINT `trim_click_regions_ibfk_2` FOREIGN KEY (`region_id`) REFERENCES `regions` (`id`),
  CONSTRAINT `trim_click_regions_ibfk_3` FOREIGN KEY (`city_id`) REFERENCES `cities` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC;
...
CREATE TABLE `trim_clicks` (
  ...
  CONSTRAINT `trim_clicks_ibfk_3` FOREIGN KEY (`agent_id`) REFERENCES `user_agents` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC;
...
CREATE TABLE `trim_tweets` (
  ...
  KEY `user_id` (`user_id`),
  KEY `trim_url_id` (`trim_url_id`),
  CONSTRAINT `trim_tweets_ibfk_1` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`) ON DELETE CASCADE,
  CONSTRAINT `trim_tweets_ibfk_2` FOREIGN KEY (`trim_url_id`) REFERENCES `trim_urls` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC;
...
CREATE TABLE `trim_urls` (
  ...
  `searchtags` varchar(255) DEFAULT NULL,
  `description` varchar(512) DEFAULT NULL,
  `circular` enum('TODO','YES','NO') NOT NULL DEFAULT 'TODO',
  `clicks` int(10) unsigned NOT NULL DEFAULT '0',
  `created_at` timestamp NOT NULL DEFAULT '0000-00-00 00:00:00',
  `updated_at` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`),
...
CREATE TABLE `url_shorteners` (
  ...
  `nbprocess` enum('YES','NO') NOT NULL DEFAULT 'NO',
  `dmprocess` enum('YES','NO') NOT NULL DEFAULT 'NO',
  PRIMARY KEY (`id`),
  UNIQUE KEY `domain` (`domain`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC;
...
CREATE TABLE `user_validations` (
  ...
  `user_id` int(10) unsigned NOT NULL,
  `code` varchar(32) NOT NULL,
  `emcount` tinyint(3) unsigned NOT NULL,
  `status` enum('PENDING','VALIDATED') NOT NULL DEFAULT 'PENDING',
  `created_at` timestamp NOT NULL DEFAULT '0000-00-00 00:00:00',
  `updated_at` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`),
  UNIQUE KEY `user_id` (`user_id`),
  CONSTRAINT `user_validations_ibfk_1` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC;
...
CREATE TABLE `users` (
  ...
  `latest_news` enum('YES','NO') NOT NULL DEFAULT 'YES',
  `source` enum('MANUAL','AUTO','API') NOT NULL DEFAULT 'MANUAL',
  `ccounter` int(10) unsigned NOT NULL DEFAULT '0',
